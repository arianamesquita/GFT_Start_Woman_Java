...
/* Dadas as seguintes informações sobre as minhas séries favoritas, crie um conjunto e ordene
* este conjunto exibindo: (nome - genero - tempo de episódio);
*
* Série 1: Nome GOT, gênero: fantasia, tempoEpisodio: 60
* Série 2: Nome Dark, gênero: drama, tempoEpisodio: 60
* Série 3: That ´70s show, gênero: comédia, tempoEpisodio: 25 */
